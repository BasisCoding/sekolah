...
<head>
  ...
  <title><?= $title ?></title>
  <!-- Favicon -->
  <link rel="icon" href="<?= base_url('assets/assets/img/brand/logo.png') ?>" type="image/png">
  <!-- Fonts -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
  <!-- Icons -->
  <link rel="stylesheet" href="<?= base_url('assets/assets/vendor/nucleo/css/nucleo.css') ?>" type="text/css">
  <link rel="stylesheet" href="<?= base_url('assets/assets/vendor/jquery.scrollbar/jquery.scrollbar.css') ?>" type="text/css">
  ...
  <link rel="stylesheet" href="<?= base_url('assets/assets/vendor/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') ?>">
  ...
  <link rel="stylesheet" href="<?= base_url('assets/assets/vendor/select2/dist/css/select2.min.css') ?>">
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/fixedcolumns/3.3.3/css/fixedColumns.bootstrap4.min.css">
  <link rel="stylesheet" href="<?= base_url('assets/assets/vendor/animate.css/animate.min.css') ?>">
  <!-- Page plugins -->
  <!-- Argon CSS -->
